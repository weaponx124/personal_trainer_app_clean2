...
class SmolovBaseCycle extends StatefulWidget {
  final Program program;
  final String unit;

  const SmolovBaseCycle({super.key, required this.program, required this.unit});

  @override
  _SmolovBaseCycleState createState() => _SmolovBaseCycleState();
}

class _SmolovBaseCycleState extends State<SmolovBaseCycle> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    workoutDetails = {
      'week': week,
      'session': session,
      'workoutName': 'Smolov Base Cycle Day $session',
      'exercises': exercises,
      'unit': widget.unit,
    };
