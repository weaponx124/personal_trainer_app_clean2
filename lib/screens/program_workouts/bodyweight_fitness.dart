...
class BodyweightFitness extends StatefulWidget {
  final Program program;
  final String unit;

  const BodyweightFitness({super.key, required this.program, required this.unit});

  @override
  _BodyweightFitnessState createState() => _BodyweightFitnessState();
}

class _BodyweightFitnessState extends State<BodyweightFitness> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    workoutDetails = {
      'week': week,
      'session': session,
      'workoutName': 'Bodyweight Fitness Day $session',
      'exercises': exercises,
      'unit': widget.unit,
    };
