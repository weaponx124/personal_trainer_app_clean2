...
class StartingStrength extends StatefulWidget {
  final Program program;
  final String unit;

  const StartingStrength({super.key, required this.program, required this.unit});

  @override
  _StartingStrengthState createState() => _StartingStrengthState();
}

class _StartingStrengthState extends State<StartingStrength> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    workoutDetails = {
      'week': week,
      'session': session,
      'workoutName': 'Starting Strength Day $session',
      'exercises': exercises,
      'unit': widget.unit,
    };
